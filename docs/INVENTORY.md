...
| `BrahmasphutaSiddhanta` | `HELD` | Brahmagupta · 628 | `brahmasphuta_siddhanta`, 21 of 25 chapters / 691 units — ch.1, 10, 22, 25 absent; **do not pad to 24**. Siddhānta astronomy. Rights: the corpus JSON is public, so only the OCR of Rupali's scan is used, never the licence-barred GRETIL/TITUS text that seeded the reference copy. | 100% |
| `GargaHora` | `HELD` | Garga (trad.) · early | `garga_hora`, **3 chapters / 378 verses** (2026-09-24). Chapter 1 is 84 verses, monotonic 1..84, no gaps, numbered by the print edition itself. **Chapters 2-3 (146 + 148) are segmented by the EDITION'S OWN printed structure** — each śloka is followed by its Hindi gloss, so a verse closes where the gloss begins (confirmed by reading page 40 of the scan). Corroborated by subject matter: ch2 runs 12 lords × 12 houses (144 expected, 146 found), ch3 the 9 grahas × 12 houses plus lagna/aspect material (148). **The edition prints NO verse numbers there — six confirmations — so these numbers are positional and editorial; never cite them.** **A DIFFERENT WORK from `GargaSamhita` below, and only this one is jyotiṣa** — the horā (natal) text, where the Saṃhitā is omens. | 100% |
...
| `JaiminiSubodhini` | `SOURCED` | Nīlakaṇṭha · MS dated Saṃvat 1885 (≈1828 CE) | **One witness, not two — corrected 2026-09-23 the same day it was filed.** **Held: Jammu MS 882-घ**, Śrī Raghunātha Temple MSS Library — `जैमिनिसूत्राणि सव्याख्यानि`, wrapper naming `सुबोधिनी व्याख्या` and `कर्ता नीलकंठः`, **Subject: ज्योतिषम्**, 46 folios, `अपूर्णम्`: folio 1 reads `जैमिनीयसूत्रद्वितीयाध्यायपर्यंतसटीक` — ṭīkā only as far as adhyāya 2. CC-0 (Dharmartha Trust J&K / eGangotri), 94 page-images, **no OCR layer** — the only extractable text is the CC-0 watermark. **REJECTED: the Bombay 1947 printed `जैमिनिसूत्रवृत्तिः सुबोधिनीनामिका` is Jaimini's PŪRVA MĪMĀṂSĀ SŪTRA**, not the jyotiṣa work — Vedic ritual exegesis. Moved to `_out-of-scope/`, which carries the evidence. **This row said the two were complementary witnesses covering adhyāyas 1–3. They were never the same work.** The catalogue label is what separates them: the Jammu MS states `ज्योतिषम्`; the printed volume states no subject, and its body is `सामिधेनी` / `उपवीत` / `अधिकरण` / `दर्शपूर्णमास`. **OCR IS RULED OUT, measured 2026-09-23 — the MS is HANDWRITTEN.** Four tesseract configurations over 12 sampled folios: Devanagari ratio a healthy 69.8% (blind, G55), real-word hits at noise level, and **two configs agreed on 0.07 of characters over identical pixels** — a reading that is not reproducible is not a reading. Renders were sound (~3900x1830, `/Rotate 90` honoured) and there is no shadowed text layer, so the medium is the cause: scribal hand, scriptio continua, marginal glosses in a second hand, red rubrication, heavy verso bleed-through. **G68.** **Separately CONFIRMED as the genuine jyotisha witness by reading the folios** — f.92 carries `उपपदं` and repeated `उपदेशा[त्]` with कुज/शुक्र/चंद्र/बुध/गुरु/शनि, पितृभावे, भ्रातृ, गर्भनाश; f.66 carries होरा, पापदृष्टिः, पापयोगे, सप्तमाद्राशेः कलत्रादि. `उपपद` is a signature Jaimini term and the commentary cites the `उपदेशसूत्र`, so the Bombay rejection's negative finding now has a positive counterpart. **Digitisation is a human reading 46 folios; there is no machine route.** |
