...
| `JaiminiSubodhini` | `UNSOURCED` | Nīlakaṇṭha · date uncertain | **The name is ambiguous and that is the first finding.** Nīlakaṇṭha's commentary on the Jaimini Sūtras is the **Subodhinī**, and it is the most widely attested of them — manuscripts in almost every Oriental MSS library. A bare *"Nīlakaṇṭhī"* much more commonly denotes the **Tājika Nīlakaṇṭhī**, Nīlakaṇṭha Daivajña's *Tājika* (Perso-Arabic) work — a different author and a different subject. **G26:** at least four Nīlakaṇṭhas are in play (Daivajña · Somayāji the Kerala astronomer · Caturdhara the Mahābhārata commentator · the Jaimini commentator). No openly-licensed Sanskrit e-text found; the only English is a commercial translation (K. Guru Rajesh). **A CC0 `Jaimini Sūtra Vṛtti Subodhinī` IS on archive.org — it is SARVEŚVARĀNANDA's, not Nīlakaṇṭha's.** Do not acquire it as this row. Wanted as the principal commentarial witness for the Jaimini recension question already recorded on the held Jaimini Sūtra row above. |
| `JyotishaKalpalata` | `UNSOURCED` | Somanātha · date uncertain | Somanātha's `Jyotiṣa Kalpalatā`, a commentary covering four chapters — kāraka, ascendant, drekkāṇa, navāṃśa — in which he argues his own positions against orally transmitted teaching. **Its incompleteness is inherent, not a sourcing gap: the last three quarters of chapter 4 survive in no manuscript at all.** Any `count_authority` must say so rather than record a gap against a notional complete text. Only a commercial Kindle edition carrying the Sanskrit (chs 1–3 plus ch4's first quarter, Medavarapu Sampath Kumar) was found; no open text. |
